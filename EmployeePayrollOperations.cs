...
namespace EmployeePayrollSystemThreads
{
    public class EmployeePayrollOperations
    {
        ...
        */
        ...
        public static string connectionString = @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=payroll_services;Integrated Security=True"; //Specifying the connection string from the sql server connection.
